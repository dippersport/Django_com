...
# def order_list(request, client_id=None):
...
#     products_last_week = Order.get_products_in_time_range(client_orders, last_week)

#     last_month = datetime.now() - timedelta(days=30)
#     products_last_month = Order.get_products_in_time_range(client_orders, last_month)

    
#     last_year = datetime.now() - timedelta(days=365)
#     products_last_year = Order.get_products_in_time_range(client_orders, last_year)
